...
from utils import extract_preprocess, cal_k, load_label
...
def multi_process(args, labelList):
    for i in labelList:
        ...
        print(label)
        # if label not  in ['024_2', '035_1', '037_4']:continue
...
def parse_args():
    ...
    parser.add_argument('--dataset', default='SMIC', type=str, help="SAMM/CAS/SMIC")
    parser.add_argument('--root_path', default='/media/sai/data1/datasets/face/emotion/SMIC/align_224',
                        type=str)
